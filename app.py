...
if student_file:
    ...
    with col1:
        st.markdown("""
**Step 1: Prepare your CSV file** with the following format:
```
ANSWER,A,C,A,D,B,...
StudentID,Q1,Q2,Q3,Q4,Q5,...
S001,A,C,B,D,A,...
...
S003,A,A,B,C,D,...
```
*Baris 1 = kunci jawaban. Baris 2 = header. Baris 3 dst = jawaban siswa.*
        """)
    with col2:
        st.markdown("""
